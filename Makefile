...
# Source files
MAIN_SRCS = src/main.cpp src/script_parser.cpp src/story_engine.cpp src/ui_renderer.cpp src/audio_manager.cpp src/save_manager.cpp src/relationship_ui.cpp
TEST_SRCS = tests/test_script_parser.cpp src/script_parser.cpp src/story_engine.cpp src/save_manager.cpp src/relationship_ui.cpp
